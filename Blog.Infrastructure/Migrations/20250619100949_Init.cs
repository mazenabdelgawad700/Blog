        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LikedAt = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PostId_IsDeleted_IsApproved_CreatedAt",
                table: "Comments",
                columns: new[] { "PostId", "IsDeleted", "IsApproved", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_PostId_UserId_Unique",
                table: "Likes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostPictures_PostId_DisplayOrder",
                table: "PostPictures",
